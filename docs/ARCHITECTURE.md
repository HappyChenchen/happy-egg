...
| 方向 | 类型 | 关键字段 | 用途 |
| --- | --- | --- | --- |
| 客户端 → Relay | `join` | `room`, `name`, `peerID` | 加入 8 位短码或旧版 64 位房间 |
...
| 客户端 → Relay | `friend-event` | `targetPeerID`, `kind`, `frameName` | 向双向在线好友发送互动 |
